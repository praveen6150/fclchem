...
export const HeroSection: React.FC<Props> = ({
  ...
  return (
    <section id="hero" className="relative bg-[#030712] text-white overflow-hidden py-16 lg:py-24 border-b border-[#1e293b]">
      
      {/* Background Ambience & Golden Glow Gradient */}
      <div className="absolute inset-0 z-0 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(245,158,11,0.12),rgba(0,0,0,0))]" />

      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Top Sound & Network Security Prompt Banner */}
        <div className="mb-8 flex flex-wrap items-center gap-3">
          <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-[#0a1120]/90 border border-amber-500/30 text-amber-300 text-xs font-mono shadow-xl backdrop-blur-md">
            ...
            <button
              ...
              className="ml-2 underline font-semibold hover:text-white cursor-pointer"
            >
              {isMuted ? 'ENABLE AUDIO' : 'AUDIO ON'}
            </button>
          </div>

          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#0a1120]/90 border border-[#1e293b] text-slate-300 text-xs font-mono">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-2">
              <span className="text-amber-500 font-mono text-xs font-bold uppercase tracking-wider block">
                DUBAI, UAE • ESTABLISHED {COMPANY_INFO.established}
              </span>
              <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black text-white tracking-tight leading-tight">
                Corporate Presentation & <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-300 to-amber-500">Enterprise Reports Portal</span>
              </h1>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              ...
              <button
                ...
                className="flex items-center gap-2.5 px-6 py-3.5 rounded-xl bg-gradient-to-r from-amber-500 via-amber-500 to-yellow-500 hover:from-amber-600 hover:to-amber-500 text-slate-950 font-bold text-sm shadow-xl shadow-amber-500/20 active:scale-95 transition-all cursor-pointer"
              >
              ...
              <button
                ...
                onMouseEnter={() => audioEngine.playHover()}
                className="flex items-center gap-2 px-6 py-3.5 rounded-xl bg-[#0a1120] border border-[#1e293b] hover:border-amber-500/50 text-slate-100 font-bold text-sm hover:bg-slate-900 transition-all cursor-pointer"
              >
            ...
            <div className="p-4 rounded-xl bg-[#0a1120]/90 border border-amber-500/20 text-xs space-y-1 text-slate-300 max-w-xl shadow-lg">
          ...
          <div className="lg:col-span-5">
            <div className="relative bg-[#0a1120] border border-amber-500/30 rounded-3xl p-6 sm:p-8 shadow-2xl shadow-amber-500/5 backdrop-blur-md space-y-6">
              ...
              <div className="space-y-3 text-xs">
                <div className="p-3 bg-[#060b16] rounded-xl border border-[#1e293b] flex items-start gap-3">
              ...
              <button
                ...
                className="w-full py-3 bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-600 hover:to-amber-500 text-slate-950 font-bold text-xs rounded-xl shadow-lg shadow-amber-500/20 transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
